...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__providers_rest_userprofiles_rest_userprofiles__ = __webpack_require__(37);
...
var AddChatPage = /** @class */ (function () {
    function AddChatPage(navCtrl, viewCtrl, userProfileProvider, navParams) {
    ...
    AddChatPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        this.token = this.navParams.get('token');
        this.userProfileProvider.getUserProfiles(this.token).subscribe(function (userProfiles) {
    ...
    AddChatPage.prototype.filterItems = function () {
    ...
    AddChatPage.prototype.startChat = function (chatUserId) {
        this.viewCtrl.dismiss({
            startChatWith: chatUserId
        });
    };
    AddChatPage.prototype.close = function () {
        this.viewCtrl.dismiss();
    };
    AddChatPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["m" /* Component */])({
            selector: 'page-add-chat',template:/*ion-inline-start:"C:\Users\Barry\Documents\ionicProjects\SocialApp\src\pages\add-chat\add-chat.html"*/'<ion-header>\n\n  <ion-navbar>\n\n    <ion-title>Start a Chat</ion-title>\n\n    <ion-buttons>\n\n      <button ion-button icon-only (click)="close()">\n\n        <ion-icon name="close"></ion-icon>\n\n      </button>\n\n    </ion-buttons>\n\n  </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n<ion-content> \n\n<ion-list>\n\n  <ion-item *ngFor="let user of userProfiles"  (click)="startChat(user.id)" tappable>\n\n    {{ user.firstname }}  {{user.lastname}}\n\n    <ion-icon item-end name="arrow-forward"></ion-icon>\n\n  </ion-item>\n\n</ion-list>\n\n\n\n  \n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\Barry\Documents\ionicProjects\SocialApp\src\pages\add-chat\add-chat.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["h" /* NavController */], __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["l" /* ViewController */], __WEBPACK_IMPORTED_MODULE_0__providers_rest_userprofiles_rest_userprofiles__["a" /* RestUserProfilesProvider */], __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["i" /* NavParams */]])
    ], AddChatPage);
    return AddChatPage;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_rest_users_rest_users__ = __webpack_require__(86);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_rest_chats_rest_chats__ = __webpack_require__(87);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_token__ = __webpack_require__(32);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__add_chat_add_chat__ = __webpack_require__(112);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__chat_chat__ = __webpack_require__(113);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_token__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_rest_groups_rest_groups__ = __webpack_require__(179);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__tasks_tasks_tasks__ = __webpack_require__(116);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__userprofiles_user_profiles_user_profiles__ = __webpack_require__(120);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__groups_groups__ = __webpack_require__(114);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__timelines_timelines__ = __webpack_require__(124);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MainPage = /** @class */ (function () {
    ...
    MainPage.prototype.goToTasks = function (event) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_token__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_rest_tasks_rest_tasks__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__task_details_task_details__ = __webpack_require__(117);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__add_task_add_task__ = __webpack_require__(118);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__update_task_update_task__ = __webpack_require__(119);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__user_profile_details_user_profile_details__ = __webpack_require__(121);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__add_user_profile_add_user_profile__ = __webpack_require__(122);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__update_user_profile_update_user_profile__ = __webpack_require__(123);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_token__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_rest_timelines_rest_timelines__ = __webpack_require__(88);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var RestGroupsProvider = /** @class */ (function () {
    function RestGroupsProvider(httpClient) {
        ...
        this.baseUrl = "https://shrouded-harbor-31805.herokuapp.com/chats"; //"https://shrouded-harbor-31805.herokuapp.com/chats";  "http://localhost:3000/chats";
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__mainpage_mainpage__ = __webpack_require__(115);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_token__ = __webpack_require__(32);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_onesignal__ = __webpack_require__(222);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__app_component__ = __webpack_require__(305);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_home_home__ = __webpack_require__(223);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pages_register_register__ = __webpack_require__(125);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__pages_chat_chat__ = __webpack_require__(113);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__pages_add_chat_add_chat__ = __webpack_require__(112);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__pages_mainpage_mainpage__ = __webpack_require__(115);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__pages_tasks_tasks_tasks__ = __webpack_require__(116);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__pages_tasks_task_details_task_details__ = __webpack_require__(117);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__pages_tasks_add_task_add_task__ = __webpack_require__(118);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__pages_tasks_update_task_update_task__ = __webpack_require__(119);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__pages_userprofiles_user_profiles_user_profiles__ = __webpack_require__(120);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__pages_userprofiles_user_profile_details_user_profile_details__ = __webpack_require__(121);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__pages_userprofiles_add_user_profile_add_user_profile__ = __webpack_require__(122);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__pages_userprofiles_update_user_profile_update_user_profile__ = __webpack_require__(123);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__pages_timelines_timelines__ = __webpack_require__(124);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__providers_rest_rest__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__providers_token__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__providers_rest_tasks_rest_tasks__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__pages_groups_groups__ = __webpack_require__(114);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__providers_rest_chats_rest_chats__ = __webpack_require__(87);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__providers_rest_groups_rest_groups__ = __webpack_require__(179);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__providers_rest_users_rest_users__ = __webpack_require__(86);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__providers_rest_timelines_rest_timelines__ = __webpack_require__(88);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32__providers_rest_userprofiles_rest_userprofiles__ = __webpack_require__(37);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_27__pages_groups_groups__["a" /* GroupsPage */]
            ],
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["e" /* IonicModule */].forRoot(__WEBPACK_IMPORTED_MODULE_9__app_component__["a" /* MyApp */], {}, {
                    links: [
                        ...
                        { loadChildren: '../pages/chat/chat.module#ChatsPageModule', name: 'ChatPage', segment: 'chat', priority: 'low', defaultHistory: [] },
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_26__providers_rest_tasks_rest_tasks__["a" /* RestTasksProvider */],
                __WEBPACK_IMPORTED_MODULE_8__ionic_native_onesignal__["a" /* OneSignal */],
                __WEBPACK_IMPORTED_MODULE_28__providers_rest_chats_rest_chats__["b" /* RestChatsProvider */],
                __WEBPACK_IMPORTED_MODULE_29__providers_rest_groups_rest_groups__["a" /* RestGroupsProvider */],
                __WEBPACK_IMPORTED_MODULE_30__providers_rest_users_rest_users__["a" /* RestUsersProvider */],
                __WEBPACK_IMPORTED_MODULE_32__providers_rest_userprofiles_rest_userprofiles__["a" /* RestUserProfilesProvider */],
                __WEBPACK_IMPORTED_MODULE_31__providers_rest_timelines_rest_timelines__["a" /* RestTimelinesProvider */],
                __WEBPACK_IMPORTED_MODULE_25__providers_token__["a" /* MySessionToken */]
            ]
        })
    ], AppModule);
    return AppModule;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_splash_screen__ = __webpack_require__(219);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_onesignal__ = __webpack_require__(222);
...
var RestUserProfilesProvider = /** @class */ (function () {
    function RestUserProfilesProvider(httpClient) {
        this.httpClient = httpClient;
        this.baseUserProfileUrl = "https://shrouded-harbor-31805.herokuapp.com/userinfos"; //"https://shrouded-harbor-31805.herokuapp.com/userinfos";  "http://localhost:3000/userinfos";
...
var RestTasksProvider = /** @class */ (function () {
    function RestTasksProvider(httpClient) {
        this.httpClient = httpClient;
        this.baseTaskUrl = "https://shrouded-harbor-31805.herokuapp.com/tasks"; //"https://shrouded-harbor-31805.herokuapp.com/tasks";  "http://localhost:3000/tasks";
...
var RestProvider = /** @class */ (function () {
    function RestProvider(httpClient) {
        this.httpClient = httpClient;
        this.keztraAuthURL = "https://shrouded-harbor-31805.herokuapp.com/authenticate"; // "https://shrouded-harbor-31805.herokuapp.com/authenticate";  "http://localhost:3000/authenticate";
...
var RestUsersProvider = /** @class */ (function () {
    function RestUsersProvider(httpClient) {
        this.httpClient = httpClient;
        this.baseUsersUrl = "http://localhost:3000/users"; //"https://shrouded-harbor-31805.herokuapp.com/users";  "http://localhost:3000/users";
        this.baseRegUrl = "http://localhost:3000/register"; //"https://shrouded-harbor-31805.herokuapp.com/register";  "http://localhost:3000/register";
...
var RestChatsProvider = /** @class */ (function () {
    function RestChatsProvider(httpClient) {
        this.httpClient = httpClient;
        this.baseChatUrl = "https://shrouded-harbor-31805.herokuapp.com/posts"; //"https://shrouded-harbor-31805.herokuapp.com/posts";  "http://localhost:3000/posts";
...
var RestTimelinesProvider = /** @class */ (function () {
    function RestTimelinesProvider(httpClient) {
        this.httpClient = httpClient;
        this.baseTimelineUrl = "https://shrouded-harbor-31805.herokuapp.com/timelines"; //"https://shrouded-harbor-31805.herokuapp.com/timelines";  "http://localhost:3000/timelines";
