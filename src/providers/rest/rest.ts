...
export class RestProvider {
  keztraAuthURL:string = "http://shrouded-harbor-31805.herokuapp.com/authenticate"; // "https://shrouded-harbor-31805.herokuapp.com/authenticate";  "http://localhost:3000/authenticate";
